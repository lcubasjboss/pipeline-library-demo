...
//sh ("git config -l")
    ...
    sh("git init .")
    //sh("git remote add performance-test-results3 git@github.com:lcubasjboss/performance-test-results.git")
    sh("git remote add performance-test-results3 https://github.com/lcubasjboss/performance-test-results.git")
